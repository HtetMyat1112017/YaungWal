                    ...
                    <form action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control  @error('product_name') is-invalid  @enderror" name="product_name" placeholder="Enter a something" value="{{old('product_name')}}">
                                @error('product_name')  <small class="text-danger">{{$message}}</small> @enderror
                            </div>

                            <div class="col-12 mb-3">
                                <label for="" class="form-label">Product Photo</label>
                                <input type="file" class="form-control  @error('product_photo') is-invalid @enderror" name="product_photo" >
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" class="form-control  @error('product_full_price') is-invalid @enderror" name="product_full_price"  placeholder="Enter a something" >
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" class="form-control  @error('product_half_price') is-invalid @enderror" name="product_half_price"  placeholder="Enter a something"  >
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" class="form-control  @error('product_weight')  is-invalid  @enderror" name="product_weight"   placeholder="Enter a g or kg" >
                                @error('product_weight') <small class="text-danger">{{$message}}</small> @enderror
                            </div>

                            <div class="col-12 mb-3">
                                <label for="" class="form-label">Product Description</label>
                                <textarea name="product_description"  class="form-control   @error('product_description') is-invalid @enderror" id=""  cols="20" rows="5">{{old('product_weight')}}</textarea>
